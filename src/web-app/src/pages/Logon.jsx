  ...
  return (
    <section className="flex border-2 items-center w-full  justify-center h-screen md:h-[80vh]  bg-white max-w-screen-xl ">
      <div className="flex w-full md:w-3/6 flex-col items-center ">
        <h1 className="md:text-3xl lg:text-5xl text-4xl mt-10 mb-14 lg:mb-4 font-bold text-colors-whatsapp-green">
          Cadastro
        </h1>
        ...
        >
          ...
          <div className="flex  items-center mt-3 lg:mt-1">
            <input
              ...
              type={"password"}
              placeholder={
                showExlamation ? "Senhas não são iguais" : "Senha"
              }
              className="text-lg rounded-3xl p-3 w-full"
              value={password}
              ref={nameInputRef}
          ...
          <button
            className="mt-12 lg:mt-4 transition-all duration-300 hover:bg-colors-whatsapp-green-button/80 p-1 md:w-5/5 bg-colors-whatsapp-green-button rounded-lg text-white font-bold text-xl"
            type="submit"
          >
            Cadastro
          </button>
        ...
        <div className="text-colors-blue-link mt-8 lg:mt-3">
          <span>Já tem uma conta? Log in</span>
        </div>
      </div>

      <div className=" w-4/6 h-full max-h-screen hidden md:flex flex-col items-center bg-colors-whatsapp-green">
